...
-- Dumping structure for table ttmgrportal.roles_menu
...
-- INSERT INTO `roles_menu` VALUES ('1930', null, '质押券信息', 'pc_login.png', '2', '/file/query_files/', '215', '[]');
...
-- Dumping data for table ttmgrportal.workflow_workflow: 5 rows
/*!40000 ALTER TABLE `workflow_workflow` DISABLE KEYS */;
INSERT INTO `workflow_workflow` (`id`, `name`) VALUES
	(1, '独立交易员流程模板'),
	(3, '四角色标准工作流'),
	(5, '三角色普通工作流1'),
	(7, '三角色普通工作流2'),
...
ALTER TABLE `workflow_workflow` ADD COLUMN `parent_id` int(11) default NULL ;
